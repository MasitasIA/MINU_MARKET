      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 xl:gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-foreground-muted">
              <p>
                <strong>Razón Social:</strong> Minú Market
              </p>
              <p>
                <strong>CUIT:</strong> [Para rellenar: XX-XXXXXXXX-X]
              </p>
              <p>
                <strong>Domicilio Legal:</strong> [Para rellenar: Calle, Número,
                Ciudad, Provincia, CP]
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="h-24 w-16 bg-surface-muted flex items-center justify-center border border-dashed border-border radius-predefined">
                <span className="text-[10px] text-foreground-subtle text-center px-1 font-medium">
                  QR
                  <br />
                  ARCA
                  <br />
        ...
        <div className="border-t border-border pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-foreground-subtle">
            © {new Date().getFullYear()} Minú Market. Todos los derechos
            reservados.
          </p>
        </div>
      </div>

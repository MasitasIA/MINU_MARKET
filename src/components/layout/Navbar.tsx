      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-1 sm:gap-4">
          ...
          >
            ...
            <span className="hidden text-sm font-medium sm:block">Vender</span>
          </Link>

          <div className="h-6 w-px bg-border hidden sm:block"></div>

          <button aria-label="Ingresar a mi cuenta" className="flex items-center gap-1.5 radius-button p-2 text-foreground-muted transition-colors hover:bg-surface-muted hover:text-primary">
          ...
          <button aria-label="Ver carrito" className="relative flex items-center justify-center radius-button bg-primary/10 p-2 text-primary transition-colors hover:bg-primary/20 sm:p-2.5">
